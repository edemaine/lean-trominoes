...
/-! # Computability of direction-code list decoding -/
...
theorem horizontalOccurrenceVariableRibbonDirectionCodesTriple_primrec :
    Primrec horizontalOccurrenceVariableRibbonDirectionCodesTriple := by
