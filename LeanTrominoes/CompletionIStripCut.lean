...
-/
import LeanTrominoes.CompletionIStripExterior
import LeanTrominoes.CompletionIBrickEquivalence
...
theorem core_completion_iff_plane (palette : Cell → Fin 24) (count : Int) (hn : 0 < count)
    ...
    Tromino.I.Completable (StripCaps.coreBand .I (162*count)) (bandPrescribed palette count) ↔
