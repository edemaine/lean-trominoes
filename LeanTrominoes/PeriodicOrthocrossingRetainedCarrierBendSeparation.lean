...
/-!
# Separation of selected retained carriers from route bends

At any shared incoming or outgoing bend terminal, a selected retained lens
...
/-- Genuine routes of an incident selected retained lens and route-bend
