...
/-- A raw retained carrier route avoids any genuine route contained in a
strictly separated standard macrocell. -/
theorem
...
/-- The separated-macrocell route theorem for selected representatives. -/
theorem
    ...
    EmbeddedCNFIncidenceDrawing.RoutesAvoidEachOther
      ((drawingPlanarSATCarrierLensIncidenceDrawing
        formula link).routes
          carrierClauseIndex carrierLiteralIndex)
      (otherDrawing.routes
        otherClauseIndex otherLiteralIndex) :=
  retainedDrawingPlanarSATCarrierRoute_avoids_macrocell_of_raw_rectanglesSeparated
    wellFormed degree isLocal
      ...
      otherBounded otherClauseMember otherLiteralMember
      rectanglesSeparated

/-- If a horizontal raw retained lens is not separated from a standard
...
/-- The horizontal macrocell overlap data for selected representatives. -/
theorem
  ...
  retainedDrawingCompleteCarrierLinkRaw_horizontal_macrocell_overlap_data
    wellFormed degree isLocal
      ...
      horizontal center notSeparated

/-- If a vertical raw retained lens is not separated from a standard
...
/-- The vertical macrocell overlap data for selected representatives. -/
theorem
  ...
  retainedDrawingCompleteCarrierLinkRaw_vertical_macrocell_overlap_data
    wellFormed degree isLocal
      ((mem_retainedDrawingCompleteCarrierLinks_iff
        graph link).mp linkMem).1
      vertical center notSeparated

/-- Macrocell overlap places the macrocell center on the raw retained link's
...
/-- The supporting-segment containment theorem for selected
representatives. -/
theorem
