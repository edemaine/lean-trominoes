...
-/
import LeanTrominoes.PeriodicExactOneFieldSearch
import LeanTrominoes.PeriodicExactOneFieldBudgetPolynomial

/-! # Polynomial evaluator space for the complete local 1D exact-one decider -/
