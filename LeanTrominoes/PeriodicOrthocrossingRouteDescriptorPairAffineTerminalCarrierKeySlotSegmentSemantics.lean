...
/-! # One-segment terminal carrier-key slot semantics -/
...
so removing inactive slots leaves its one terminal-key template block. -/
theorem Segment.terminalCarrierKeyActiveValues_eq
