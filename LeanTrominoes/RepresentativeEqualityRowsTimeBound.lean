...
import LeanTrominoes.RepresentativeEqualityRowsLengthBounds
import LeanTrominoes.RepresentativeEqualityRowsRowsTimeBound

/-! # Quadratic clock bound for stable representative-row filtering -/
