...
/-! # Fixed-green local grouped variable-incidence shape -/
...
/-- Local body lookup has the typed triple/RGB shape for a fixed-green
occurrence. -/
theorem groupedVariableIncidenceLocalBodyBlock_eq_typedShape_fixedGreen
  ...
  change kind = .fixedGreen at dataKind
  subst kind
