...
/-! # Complete retained direction words from raw metadata routes -/
...
metadata route have the same complete segment-major direction word. -/
theorem representativeRoute_directions_eq_rawRepresentativeRoute
  ...
  | some clause =>
      ...
      exact
        PositionedPeriodicCNF.unitSubdivisionDirections_normalizeIncidenceRoute
