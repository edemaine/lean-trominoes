...
-/
import LeanTrominoes.RepresentativeEqualityRowsRejectedSteps

/-! # Execution of rejected-row clearing -/
...
/-- Discard a rejected row and increment the unary row index. -/
