...
-/
import LeanTrominoes.PeriodicCNFFormulaShapeRetainedPlanarMetadataTargetTerminalGaugeHorizontal
import LeanTrominoes.PeriodicCNFFormulaShapeRetainedPlanarMetadataTargetTerminalPositionVertical

/-! # Vertical gauges of routed target terminals -/
...
/-- The vertical target-terminal gauge is its incidence-edge offset. -/
theorem retainedGauge_targetTerminal_vertical_eq_edgeOffset
  ...
  change
    (drawingPeriodicPlanarSATVariablePosition source
      ...
      occurrence.edge.offset.2
  exact targetTerminal_position_vertical_ediv_eq_edgeOffset
