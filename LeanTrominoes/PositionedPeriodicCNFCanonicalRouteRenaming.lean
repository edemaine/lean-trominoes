...
/-- Any property depending only on a clause/literal presentation index
transfers through variable renaming. -/
theorem incidenceIndexProperty_rename
    {Source Target : Type*}
    ...
    (sourceProperty :
      ∀ sourceClause sourceClauseIndex,
        ...
        ∀ sourceLiteral sourceLiteralIndex,
          ...
          property sourceClauseIndex sourceLiteralIndex)
    ...
    property clauseIndex literalIndex := by
  change
    (targetClause, clauseIndex) ∈
