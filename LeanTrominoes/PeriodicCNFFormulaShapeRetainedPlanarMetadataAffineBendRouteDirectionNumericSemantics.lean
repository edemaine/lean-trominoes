...
/-! # Numeric semantics of retained-bend route direction selection -/
...
exactly four delimited route words for every semantic untranslated bend. -/
theorem affineBaseBendRouteDirectionBlock_numeric_diagonal
  ...
  rw [affineBaseBendRouteDirectionBlock_eq_of_matches
