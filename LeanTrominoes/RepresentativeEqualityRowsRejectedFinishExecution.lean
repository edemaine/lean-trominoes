...
-/
import LeanTrominoes.RepresentativeEqualityRowsRejectedExecution
import LeanTrominoes.RepresentativeEqualityRowsSuffixSteps

/-! # Finishing a rejected representative row -/
...
/-- Branch to rejected-row clearing and discard the row. -/
