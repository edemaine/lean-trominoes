...
-/
import LeanTrominoes.RepresentativeEqualityRowsIndexSetupExecution

/-! # Opening a row and preparing its unary index -/
...
/-- Consume a row's opening delimiter and prepare its prefix countdown. -/
