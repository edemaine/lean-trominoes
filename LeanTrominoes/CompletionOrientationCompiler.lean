...
import LeanTrominoes.CompletionSquareCompiler

/-! # Compiling finite periodic orientation drawings into L-tromino prefills -/
...
theorem compileDrawing_correct (drawing : PeriodicOrthogonalDrawing) (wf : drawing.IsWellFormed) :
    PeriodicTrominoPrefill.planeProblem .L (compileDrawing drawing) ↔ drawing.HasOrientation := by
  rw [compileDrawing,PeriodicPattern.compileSquare_correct _ _ (macro_palette_periodic drawing)]
  rw [← Circuit.macro_reduction_correct,← drawing_source_correct drawing wf]
