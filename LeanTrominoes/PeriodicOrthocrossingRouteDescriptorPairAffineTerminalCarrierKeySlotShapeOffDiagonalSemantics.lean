...
/-! # Off-diagonal route-shape terminal carrier-key slots -/
...
/-- Unequal stored edge indices make every terminal-key slot of one route
shape inactive. -/
theorem RouteShape.terminalCarrierKeyActiveValues_eq_nil_of_edgeIndex_ne
