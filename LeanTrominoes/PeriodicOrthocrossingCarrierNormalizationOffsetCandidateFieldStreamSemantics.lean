...
import LeanTrominoes.PeriodicOrthocrossingCarrierNormalizationOffsetCandidateFieldStreamCompiler
import LeanTrominoes.PeriodicOrthocrossingCarrierNormalizationOffsetFieldStreamSemantics
import LeanTrominoes.TM2PolyTimeInputEncodingTransport
import LeanTrominoes.TM2PolyTimeOutputEncodingTransport
import LeanTrominoes.UnaryFieldEncoderFlatMapSemantics

/-! # Semantics of carrier normalization-offset candidate field streams -/
...
@[simp] theorem terminalFields_descriptorWords
  ...
  rw [CarrierKeyRecipeStream.terminalTags_descriptorWords,
    TerminalNormalizationOffsetFieldStream.emittedFields_encodeDescriptorPairs]
  rfl
...
@[simp] theorem crossingFields_descriptorWords
  ...
  rw [CarrierKeyRecipeStream.crossingTags_descriptorWords,
    CrossingNormalizationOffsetFieldStream.emittedFields_encodeDescriptorSlotPairs]
  rfl
