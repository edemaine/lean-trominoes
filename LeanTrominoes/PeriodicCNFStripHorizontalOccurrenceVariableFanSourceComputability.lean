...
/-! # Computability of the normalized variable-fan source -/
...
theorem horizontalOccurrenceVariableSourceComputed_primrec :
    Primrec horizontalOccurrenceVariableSourceComputed := by
