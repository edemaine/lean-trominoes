...
-/
import LeanTrominoes.PeriodicCNFIncidenceRouteDescriptorEnumerationExtensionality
...
theorem directSourceRouteDescriptorTokens_eq_splitRouteDescriptors
  ...
  rw [numericRouteDescriptors_congr_decidableEq
    directSourceVariableDecidableEq inferInstance]
