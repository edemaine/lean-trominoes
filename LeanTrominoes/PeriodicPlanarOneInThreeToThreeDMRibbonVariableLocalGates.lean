...
def standardVariableLocalGateRouteAtFirst
  ...
  | .fixedGreen, false, .red =>
      [(16, 64), (17, 64), (17, 65), (19, 65),
        (19, 67), (20, 67), (20, 68), (20, 69), (21, 69),
        (21, 70), (22, 70), (22, 72), (24, 72),
        (24, 108)]
  | .fixedGreen, false, .green =>
      [(32, 72), (31, 72), (31, 73), (28, 73),
        (28, 108)]
  | .fixedGreen, false, .blue =>
      [(16, 72), (17, 72), (17, 73), (18, 73),
        (18, 77), (19, 77), (19, 78), (20, 78),
        (20, 108)]
  | .fixedGreen, true, .red =>
      [(40, 64), (41, 64), (41, 73), (40, 73),
        (40, 79), (39, 79), (39, 82), (38, 82),
        (38, 83), (35, 83), (35, 84), (34, 84),
        (34, 85), (24, 85), (24, 108)]
  | .fixedGreen, true, .green =>
      [(24, 72), (30, 72), (30, 71), (31, 71),
        (31, 69), (36, 69), (36, 68), (36, 67), (37, 67),
        (37, 65), (38, 65), (38, 63), (42, 63),
        (42, 74), (41, 74), (41, 81), (40, 81),
        (40, 87), (38, 87), (38, 92), (37, 92),
        (37, 93), (36, 93), (36, 98), (35, 98),
        (35, 100), (34, 100), (34, 103), (33, 103),
        (33, 104), (31, 104), (31, 105), (28, 105),
        (28, 108)]
  | .fixedGreen, true, .blue =>
      [(40, 72), (39, 72), (39, 73), (38, 73),
        (38, 78), (35, 78), (35, 79), (34, 79),
        (34, 80), (30, 80), (30, 82), (26, 82),
        (26, 83), (25, 83), (25, 84), (20, 84),
        (20, 108)]
  | .fixedBlue, false, .red =>
      [(16, 64), (17, 64), (17, 65), (19, 65),
        (19, 67), (20, 67), (20, 68), (20, 108)]
  | .fixedBlue, false, .green =>
      [(16, 72), (15, 72), (15, 63), (19, 63),
        (19, 64), (24, 64), (25, 64), (25, 67),
        (28, 67), (28, 68), (28, 74), (24, 74),
        (24, 108)]
  | .fixedBlue, false, .blue =>
      [(32, 72), (31, 72), (31, 77), (28, 77),
        (28, 108)]
  | .fixedBlue, true, .red =>
