...
-/
import LeanTrominoes.LastRepresentativeEqualityRowsInterface
import LeanTrominoes.LastRepresentativeEqualityRowsTimeBound

/-! # Polynomial-time last-representative row filtering -/
...
/-- Selecting last occurrences in equality-row order is polynomial time. -/
noncomputable def computableInPolyTime :
    @TM2ComputableInPolyTime
      ...
      DelimitedBinaryWords.finEncoding.encode
      LastRepresentativeEqualityRows.rows where
  tm := machine
