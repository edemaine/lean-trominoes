...
import LeanTrominoes.DelimitedBinaryWordPrefixTrueCountIndexCopyExecution
import LeanTrominoes.DelimitedBinaryWordPrefixTrueCountIndexRestoreExecution

/-! # Complete unary row-index setup for prefix counting -/
