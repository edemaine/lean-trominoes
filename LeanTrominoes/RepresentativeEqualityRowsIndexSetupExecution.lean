...
import LeanTrominoes.RepresentativeEqualityRowsIndexRestoreExecution

/-! # Complete unary row-index setup -/
...
/-- Copy and restore a unary row index, retaining a prefix countdown. -/
