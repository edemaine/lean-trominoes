...
-/
import LeanTrominoes.RepresentativeEqualityRowsRejectedFinishExecution
import LeanTrominoes.RepresentativeEqualityRowsSelectedFinishExecution

/-! # Complete representative-row finish dispatch -/
...
/-- Preserve precisely the selected rows and increment the row index. -/
