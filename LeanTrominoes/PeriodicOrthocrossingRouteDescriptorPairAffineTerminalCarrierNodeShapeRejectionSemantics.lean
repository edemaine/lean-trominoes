...
/-! # Rejected route-shape terminal carrier-node candidates -/
...
/-- A route shape whose guard fails has no active terminal-node values. -/
theorem RouteShape.terminalCarrierNodeActiveValues_eq_nil_of_not_matches
