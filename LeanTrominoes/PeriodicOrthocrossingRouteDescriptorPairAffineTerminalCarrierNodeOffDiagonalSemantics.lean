...
-/
import LeanTrominoes.PeriodicOrthocrossingRouteDescriptorPairAffineTerminalCarrierNodeShapeOffDiagonalSemantics

/-! # Off-diagonal descriptor-pair terminal carrier-node candidates -/
...
/-- The complete terminal-node shape scan is empty on an off-diagonal
descriptor pair. -/
theorem terminalCarrierNodeActiveValues_eq_nil_of_edgeIndex_ne
  ...
  · apply List.flatMap_eq_nil_iff.mpr
    ...
    exact shape.terminalCarrierNodeActiveValues_eq_nil_of_edgeIndex_ne
      pair edgeIndexNe
  · intro shape _shapeMember
