...
import LeanTrominoes.PeriodicOrthocrossingRouteDescriptorPairAffineTerminalCarrierNodeDiagonalSemantics

/-! # Numeric diagonal terminal carrier-node candidate semantics -/
...
/-- Every numeric route descriptor contributes its exact terminal-node block
on the diagonal of the descriptor square. -/
theorem terminalCarrierNodeActiveValues_numeric_diagonal
  ...
  apply terminalCarrierNodeActiveValues_diagonal descriptor
