...
/-! # Compiler for canonical-left crossing source-key components -/
...
def recipes : List Recipe :=
  RouteDescriptorOccurrenceSlotCrossing.canonicalLeftSourceKeyRecipeBlocks.flatten
...
def preparedInput
  ...
  CarrierKeyRecipeEmitter.preparedFrom
    ...
    RouteDescriptorOccurrenceSlotCrossing.canonicalLeftSourceKeyExpandedActives
    tokens
...
noncomputable def preparedInputComputableInPolyTime :
  ...
  CarrierKeyRecipeEmitter.preparedFromComputableInPolyTime
    ...
    RouteDescriptorOccurrenceSlotCrossing.canonicalLeftSourceKeyExpandedActivesComputableInPolyTime
