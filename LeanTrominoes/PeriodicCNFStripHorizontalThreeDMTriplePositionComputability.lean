...
import LeanTrominoes.PeriodicPlanarOneInThreeToThreeDMGlobalTriplePositionComputability

/-! # Computability of concrete assembled triple positions -/
...
theorem horizontalThreeDMTriplePositionComputed_primrec :
    Primrec fun input : PeriodicCNF Nat ×
        PeriodicPlanarOneInThreeToThreeDM.Triple RoutedVariable =>
      horizontalThreeDMTriplePositionComputed input.1 input.2 := by
  exact
    PeriodicPlanarOneInThreeToThreeDM.assembledTriplePositionData_primrec
