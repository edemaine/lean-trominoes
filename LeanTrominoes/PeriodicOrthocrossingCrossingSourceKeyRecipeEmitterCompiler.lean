...
/-! # Compiler for doubled crossing source-key guarded words -/
...
def recipes : List Recipe :=
  RouteDescriptorOccurrenceSlotCrossing.crossingSourceKeyRecipeBlocks.flatten
...
noncomputable def preparedInputComputableInPolyTime :
  ...
  CarrierKeyRecipeEmitter.preparedFromComputableInPolyTime
    ...
    RouteDescriptorOccurrenceSlotCrossing.crossingSourceKeyExpandedActivesComputableInPolyTime
