...
/-- Boundary port assigned to a source literal by its index in the
unit-elimination input clause. -/
def sourceLocalPosition : Nat → Cell
  | 0 => (3, 0)
  | 1 => (0, 3)
  | _ => (6, 3)

/-- Every genuine source literal is placed at the unit-elimination boundary
port selected by its source-clause index. -/
theorem instantiatedDrawing_sourcePosition
  ...
  · rcases rest with _ | ⟨second, rest⟩
    · simp_all [instantiatedDrawing, instantiatedUnitDrawing,
        unitLocalPosition, sourceLocalPosition,
        EmbeddedCNFIncidenceDrawing.rename,
        EmbeddedCNFIncidenceDrawing.translate]
    · rcases rest with _ | ⟨third, tail⟩
      · have firstNeSecond :
        ...
        rcases literalMember with
          ⟨rfl, rfl⟩ | ⟨rfl, rfl⟩
        · simp [instantiatedDrawing, instantiatedTwoDrawing,
            twoLocalPosition, sourceLocalPosition,
            EmbeddedCNFIncidenceDrawing.rename,
            EmbeddedCNFIncidenceDrawing.translate]
        · simp [instantiatedDrawing, instantiatedTwoDrawing,
            twoLocalPosition, sourceLocalPosition,
      ...
      · have tailEmpty : tail = [] := by
        ...
        · simp [instantiatedDrawing, instantiatedThreeDrawing,
            threeLocalPosition, sourceLocalPosition,
            EmbeddedCNFIncidenceDrawing.rename,
            EmbeddedCNFIncidenceDrawing.translate]
        · simp [instantiatedDrawing, instantiatedThreeDrawing,
            threeLocalPosition, sourceLocalPosition,
            Ne.symm pairwise.1.1,
            EmbeddedCNFIncidenceDrawing.rename,
            EmbeddedCNFIncidenceDrawing.translate]
        · simp [instantiatedDrawing, instantiatedThreeDrawing,
            threeLocalPosition, sourceLocalPosition,
            Ne.symm pairwise.1.2, Ne.symm pairwise.2,
            EmbeddedCNFIncidenceDrawing.rename,
            EmbeddedCNFIncidenceDrawing.translate]
