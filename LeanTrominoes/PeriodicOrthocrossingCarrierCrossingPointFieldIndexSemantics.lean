...
/-! # Rank-scan indices of crossing-point fields -/

namespace LeanTrominoes.PeriodicOrthocrossing

open CarrierCrossingPointField

/-- Each crossing-point projector names its exact fixed column in the
fifty-field carrier rank scan. -/
@[simp] theorem CarrierNodeRankDatum.scanUnaryFields_getD_crossingPointField
  ...
  | some record =>
      ...
      cases field <;>
        simp [CarrierNodeRankDatum.scanUnaryFields,
          ...
          pointValue, CarrierCrossingPointField.horizontal,
          CarrierCrossingPointField.keepPositive, crossingEq]

namespace CarrierCrossingPointField

/-- Each compiled crossing-point family member is precisely the selected
...
theorem values_numericRouteDescriptors_eq_indexedField
  ...
  congr 1
  funext datum
  exact (datum.scanUnaryFields_getD_crossingPointField field).symm
