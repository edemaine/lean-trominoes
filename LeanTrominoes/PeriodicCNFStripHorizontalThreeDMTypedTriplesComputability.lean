...
/-! # Computability of horizontal typed triples -/
...
theorem horizontalThreeDMTypedTriplesComputed_primrec :
    Primrec horizontalThreeDMTypedTriplesComputed := by
  exact PeriodicPlanarOneInThreeToThreeDM.triples_primrec.comp
