      ...
      - [ ] Implement and verify the direct unary field emitter for the
        ...
        - [ ] Implement the polynomial-time prepared-token emitter for the
          ...
          - [ ] Implement the canonical route-record appender.
            ...
            - [x] Prove the inherited cycle tail is exactly that fixed word
              with its clause-side direction removed.
            - [x] Reduce all implication-cycle tail records to one constant
...
- [`LeanTrominoes/RetainedAngularFanFinalCoordinatedOrdinaryNormalizedFirstDirections.lean`](LeanTrominoes/RetainedAngularFanFinalCoordinatedOrdinaryNormalizedFirstDirections.lean)
  ...
  boundary.
- [`LeanTrominoes/RetainedAngularFanFinalCoordinatedNormalizedFirstDirections.lean`](LeanTrominoes/RetainedAngularFanFinalCoordinatedNormalizedFirstDirections.lean)
  combines all genuine copied-source cases at that boundary.  Successful
  direct choices use their finite normalized atlas direction, while ordinary
  and singleton-escaped fallbacks retain the scaled source-route direction.
- [`LeanTrominoes/PeriodicCNFFormulaShapeRetainedFigureNineCopiedDirectionData.lean`](LeanTrominoes/PeriodicCNFFormulaShapeRetainedFigureNineCopiedDirectionData.lean)
  packages that case split as one finite direction lookup and one canonical
  descriptor per copied retained clause, ready for the list-level semantic
...
- [`LeanTrominoes/PeriodicCNFFormulaShapeRetainedFigureNineCycleDirectionBlocks.lean`](LeanTrominoes/PeriodicCNFFormulaShapeRetainedFigureNineCycleDirectionBlocks.lean)
  decomposes the complete global routed cycle suffix into the corresponding
  fixed-width local descriptor block at each stable source-variable index.
...
- [`LeanTrominoes/PeriodicCNFPlanarRetainedCoordinatedFixedEightOrderedFigureNineLocalFarTailSeparation.lean`](LeanTrominoes/PeriodicCNFPlanarRetainedCoordinatedFixedEightOrderedFigureNineLocalFarTailSeparation.lean)
  ...
  point.
- [`LeanTrominoes/PeriodicCNFPlanarRetainedCoordinatedFixedEightOrderedFigureNineOwnRouteNormalization.lean`](LeanTrominoes/PeriodicCNFPlanarRetainedCoordinatedFixedEightOrderedFigureNineOwnRouteNormalization.lean)
...
- [`LeanTrominoes/PeriodicOrthocrossingCarrierFallbackPrefixTrimmer.lean`](LeanTrominoes/PeriodicOrthocrossingCarrierFallbackPrefixTrimmer.lean)
  ...
  routes and only the final two or one steps of the other routes.  The state
  resets at each four-route boundary; an append theorem verifies that later
  carrier blocks are preserved independently.
- [`LeanTrominoes/PeriodicCNFFormulaShapeRetainedPlanarMetadataAffineBendRoutePrefixDirectionCompiler.lean`](LeanTrominoes/PeriodicCNFFormulaShapeRetainedPlanarMetadataAffineBendRoutePrefixDirectionCompiler.lean)
  ...
  [`LeanTrominoes/PeriodicCNFFormulaShapeRetainedPlanarMetadataAffineBendRoutePrefixDirectionSelection.lean`](LeanTrominoes/PeriodicCNFFormulaShapeRetainedPlanarMetadataAffineBendRoutePrefixDirectionSelection.lean)
...
- [`LeanTrominoes/RetainedAngularFanFallbackSuffixDirectionBatchCompiler.lean`](LeanTrominoes/RetainedAngularFanFallbackSuffixDirectionBatchCompiler.lean)
  lifts the resetting suffix transducer to arbitrary compact query batches,
  preserving one route delimiter per query in polynomial time.
  [`LeanTrominoes/RetainedAngularFanFallbackSuffixDirectionBatchSemantics.lean`](LeanTrominoes/RetainedAngularFanFallbackSuffixDirectionBatchSemantics.lean)
  identifies every positive batch with the corresponding geometric scaled
  fallback-suffix family.
- [`LeanTrominoes/RetainedAngularFanFallbackSuffixQueryData.lean`](LeanTrominoes/RetainedAngularFanFallbackSuffixQueryData.lean)
  zips policy, terminal data, and occurrence slots into exact four-route
  carrier and bend query blocks and proves all their raw lengths positive.
